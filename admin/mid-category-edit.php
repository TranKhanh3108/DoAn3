...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Tên loại mặt hàng phụ không được để rỗng<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Loại mặt hàng phụ được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Sửa loại mặt hàng phụ</h1>
	</div>
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Danh sách loại mặt hàng phụ</a>
	</div>
</section>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên loại mặt hàng phụ <span>*</span></label>
                    <div class="col-sm-4">
