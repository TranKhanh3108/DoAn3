        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3>Các sản phẩm có thể bạn sẽ thích</h3>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3>Tất cả các sản phẩm có tại cửa hàng</h3>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="product pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2>Các sản phẩn phổ biến</h2>
                    <h3>Danh sách các sản phẩm phổ biến tại cửa hàng</h3>
                </div>
            </div>
        </div>
        <div class="row">
